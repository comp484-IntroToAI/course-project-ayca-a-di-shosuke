...
if __name__ == "__main__":
    ...
    #     for vocabs in [1000, 10000, 50000]:
        for vocabs in [1000, 10000]:

            # POP_SIZE = pops
            SAMPLE_SIZE = samples
            VOCAB_SIZE = vocabs   

            # if not (POP_SIZE == 50 and SAMPLE_SIZE == 10) and not (POP_SIZE == 50 and SAMPLE_SIZE == 50 and (VOCAB_SIZE == 1000 or VOCAB_SIZE == 10000)):
            if not (SAMPLE_SIZE == 10 and VOCAB_SIZE == 1000):
